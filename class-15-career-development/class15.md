...
#Code Review Singly Linked Lists#
1.
2.
3.
4. There is a recursive solution to 'remove'. Find it.
#Stacks & Queues Introduction#
1.
2.
3.
4.
#Whiteboarding in Groups of Two#
1.
2. implement a function to determine if a string has matching brackets--building a linter. Whoa.  
3.
